...
export async function GET(
    ...
    try {
        const product = await AttributeTypesService.getOne(parseInt(id));
...
export async function PUT(
    ...
    try {
        ...
        const updatedData = await  AttributeTypesService.update(parseInt(id), data);
        // Retornar la respuesta
...
export async function DELETE(
    ...
    try {
        const res = await AttributeTypesService.delete(parseInt(id));
        // Retornar la respuesta
