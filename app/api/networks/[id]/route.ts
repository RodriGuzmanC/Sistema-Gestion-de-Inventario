...
export async function GET(
    ...
    try {
        const data = await SocialNetworkService.getOne(parseInt(id));
...
export async function PUT(
    ...
    try {
        ...
        const updatedData = await SocialNetworkService.update(parseInt(id), data);
        // Retornar la respuesta
...
export async function DELETE(
    ...
    try {
        const deleteData = await SocialNetworkService.delete(parseInt(id));
        // Retornar la respuesta
